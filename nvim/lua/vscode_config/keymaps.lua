...
keymap('n', '<leader>w', vscode_action('workbench.action.files.save'), { desc = 'Save file' })
keymap('n', '<leader>q', vscode_action('workbench.action.closeActiveEditor'), { desc = 'Close editor' })
